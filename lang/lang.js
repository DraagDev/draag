...
var translations = {
    'en':{
        ...
        'footerText': "Founded in 1987, draag food security started with a simple yet passionate idea: to provide the best quality turkey products from a breed imported from France.",
    ...
    'ar':{
        ...
        'footerText': 'تأسست دراج للامن الغذائي في عام 1987 بفكرة بسيطة ولكنها مليئة بالشغف و هو توفير أفضل منتجات الديك الرومي من سلالات مستوردة من فرنسا',
