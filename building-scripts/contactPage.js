...
const buildContent = () =>{
    ...
    if (element) {
      element.innerHTML =
        ...
        '                       <span data-i18n="addressContent"></span>'+
        '                   </li>'+
        '                   <li>'+
        ...
        '                   <h6 class="text-center" style="font-weight:500; font-size:1.1rem;"><span data-i18n="leaveAMessage1"></span><br/><span  data-i18n="leaveAMessage2"></span></h6>'+
...
const inserGoogleMap = () => {
  ...
  if (element) {
    element.innerHTML =
    '<iframe style="border:0; '+(language==="en" ? "right:0;" : "left:0;")+'" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d219498.83272269816!2d31.046893100746114!3d30.72769708723842!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f7b8a8a49cb9e1%3A0x640cf1f3f686f3d7!2sZefta%2C%20Gharbia%20Governorate!5e0!3m2!1sen!2seg!4v1684863564296!5m2!1sen!2seg" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>'
